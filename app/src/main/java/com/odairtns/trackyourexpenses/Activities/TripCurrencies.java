...
import com.odairtns.trackyourexpenses.Adapters.TripCurrenciesAdapter;
import com.odairtns.trackyourexpenses.Data.DbHandler;
import com.odairtns.trackyourexpenses.Models.Currency;
import com.odairtns.trackyourexpenses.Models.Trip;
import com.odairtns.trackyourexpenses.Models.TripCurrency;
import com.odairtns.trackyourexpenses.R;
import com.odairtns.trackyourexpenses.Util.Constants;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refreshButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                al.setTitle(R.string.warning);
                al.setIcon(android.R.drawable.ic_dialog_alert);
                al.setMessage(R.string.update_exg_rate_message);
                ...
                al.setNegativeButton(R.string.no, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                    }
